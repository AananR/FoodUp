...
<body>
  <section class="menu cid-qOzngTNoX2" once="menu" id="menu1-17">
...
<section class="engine"><a href="https://mobirise.ws/f">easy web maker</a></section><section class="features11 cid-qOzngU6MjM" id="features11-18">
        ...
        <div class="col-md-12">
            <div class="media-container-row">
                <div class="mbr-figure" style="width: 50%;">
                    <img src="assets/images/evoo-550x366.jpg" alt="Mobirise" title="">
                </div>
...
<section class="map2 cid-qOzkrngSL4" id="map2-m">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="col-md-8">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:Eio0MzggUHJlc3RvbiBTdCwgT3R0YXdhLCBPTiBLMVMgNE40LCBDYW5hZGE" allowfullscreen=""></iframe></div>
        </div>
    </div>
</div></section>
