    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">Fast Food</h2>
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            ...
            <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7"><?php echo $arrayobj[0]; ?></td><td class="body-item mbr-fonts-style display-7"><?php echo $arrayobj[1]; ?></td></tr><tr> 
                
                
                
                
              <td class="body-item mbr-fonts-style display-7"><?php echo $arrayobj[2]; ?></td><td class="body-item mbr-fonts-style display-7"><?php echo $arrayobj[3]; ?></td></tr><tr> 
                
                
                
                
              <td class="body-item mbr-fonts-style display-7"><?php echo $arrayobj[4]; ?></td><td class="body-item mbr-fonts-style display-7"><?php echo $arrayobj[5]; ?></td></tr>

            <td class="body-item mbr-fonts-style display-7"><?php echo $arrayobj[6]; ?></td><td class="body-item mbr-fonts-style display-7"><?php echo $arrayobj[7]; ?></td></tr>

          <td class="body-item mbr-fonts-style display-7"><?php echo $arrayobj[8]; ?></td><td class="body-item mbr-fonts-style display-7"><?php echo $arrayobj[9]; ?></td></tr></tbody>
          </table>
        </div>
    ...
    <div class="container">
        <div class="media-container-row pt-5">
            ...
            <div class="mbr-figure" style="width: 105%;">
                    <img src="assets/images/mbr-1-1042x695.jpg" alt="Mobirise" title="">
            </div>
        </div>
    </div>
</section>

<section once="" class="cid-qOAGAsWC83" id="footer6-2q">
