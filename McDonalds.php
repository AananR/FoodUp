...
<body>
  <section class="menu cid-qOznq8CNcc" once="menu" id="menu1-1m">
...
<section class="engine"></section><section class="features11 cid-qOznq8WQ5K" id="features11-1n">
        ...
        <div class="col-md-12">
            <div class="media-container-row">
                <div class="mbr-figure" style="width: 50%;">
                    <img src="assets/images/mcdees-500x375.jpg" alt="Mobirise" title="">
                </div>
...
<section class="map2 cid-qOzkrngSL4" id="map2-m">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="col-md-8">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJ9Si_tPEGzkwR2KG7pNrwrY4" allowfullscreen=""></iframe></div>
        </div>
    </div>
</div></section>
