...
<body>
  <section class="menu cid-qOznUPguLE" once="menu" id="menu1-2b">
...
<section class="engine"></section><section class="features11 cid-qOznUPzhcb" id="features11-2c">
        ...
        <div class="col-md-12">
            <div class="media-container-row">
                <div class="mbr-figure" style="width: 50%;">
                    <img src="assets/images/zaks-960x540.jpg" alt="Mobirise" title="">
                </div>
...
<section class="section-table cid-qOAWps3xJ5" id="table1-3s">
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            ...
            <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7"><?php echo $arrayobjMenu[9]; ?></td><td class="body-item mbr-fonts-style display-7"><?php echo $arrayobjMenu[10]; ?></td><td class="body-item mbr-fonts-style display-7"><?php echo $arrayobjMenu[11]; ?></td></tr></tbody>
          </table>
        </div>
...
<section class="mbr-section article content12 cid-qOzn2YTn1n" id="content12-v">
...
<section class="map2 cid-qOzn2Z8URN" id="map2-w">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="col-md-8">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJ8wAMjv0EzkwR_r3hG8CPW_0" allowfullscreen=""></iframe></div>
        </div>
    </div>
</div></section>

<section class="mbr-section article content12 cid-qOAZIxhmc5" id="content12-4x">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-text counter-container col-12 col-md-8 mbr-fonts-style display-7">
                <ul>
                   <strong>First Open Date</strong> - <?php echo $arrayobj[12]; ?><br/><br/>
                    <strong>Managers Name:</strong> - <?php echo $arrayobj[13]; ?><br/><br/>
                    <strong>Phone Number: </strong> - <?php echo $arrayobj[14]; ?><br/><br/>
                    <strong>Hours of Operation: </strong>  <?php echo $arrayobj[16]; ?> to <?php echo $arrayobj[17]; ?> <br/><br/>
                     <strong>Address </strong> - <?php echo $arrayobj[15]; ?><br/><br/>
                </ul>
            </div>
        </div>
    </div>
...
<section class="map2 cid-qOAZyCsGML" id="map2-4w">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="col-md-8">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJvY1zWW4A0kwR_2U7GX6RlXI" allowfullscreen=""></iframe></div>
        </div>
    </div>
</div></section>

<section class="carousel slide testimonials-slider cid-qOAWpTLu7m" id="testimonials-slider1-3t">
        ...
        <div class="carousel slide" data-ride="carousel" role="listbox">
            ...
            <div class="carousel-item">
                    ...
                    <div class="user col-md-8">
                        ...
                        <div class="user_text pb-3">
                            <p class="mbr-fonts-style display-7">
                                <b>Food:</b>  <?php echo $arrayobjRating[46]; ?><br><br>
                                <b>Mood:</b>  <?php echo $arrayobjRating[47]; ?><br><br>
                                <b>Price:</b>  <?php echo $arrayobjRating[48]; ?><br><br>
                                <b>Staff:</b>  <?php echo $arrayobjRating[49]; ?><br><br>
                                

                            </p>
                        </div>
                        <div class="user_name mbr-bold pb-2 mbr-fonts-style display-7">
                            <?php echo $arrayobjRating[45]; ?>
                        </div>
                    ...
                    <div class="user col-md-8">
                        ...
                        <div class="user_text pb-3">
                            <p class="mbr-fonts-style display-7">
                                <b>Food:</b>  <?php echo $arrayobjRating[51]; ?><br><br>
                                <b>Mood:</b>  <?php echo $arrayobjRating[52]; ?><br><br>
                                <b>Price:</b>  <?php echo $arrayobjRating[53]; ?><br><br>
                                <b>Staff:</b>  <?php echo $arrayobjRating[54]; ?><br><br>
                                

                            </p>
                        </div>
                        <div class="user_name mbr-bold pb-2 mbr-fonts-style display-7">
                            <?php echo $arrayobjRating[50]; ?>
                        </div>
...
<section once="" class="cid-qOAWqDrRTl" id="footer6-3u">
