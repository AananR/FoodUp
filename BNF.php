...
<body>
  <section class="menu cid-qOzn2UJyrL" once="menu" id="menu1-s">
...
<section class="engine"></section><section class="features11 cid-qOzn2Vcfvg" id="features11-t">
        ...
        <div class="col-md-12">
            <div class="media-container-row">
                <div class="mbr-figure" style="width: 50%;">
                    <img src="assets/images/bff-960x540.jpg" alt="Mobirise" title="">
                </div>
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            ...
            <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7"><?php echo $arrayobjMenu[9]; ?></td><td class="body-item mbr-fonts-style display-7"><?php echo $arrayobjMenu[10]; ?></td><td class="body-item mbr-fonts-style display-7"><?php echo $arrayobjMenu[11]; ?></td></tbody>
          </table>
        </div>
...
<section class="map2 cid-qOzn2Z8URN" id="map2-w">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="col-md-8">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJL3N-uK0FzkwRie3FjnQ89o0" allowfullscreen=""></iframe></div>
        </div>
    </div>
</div></section>
...
<section class="map2 cid-qOAZyCsGML" id="map2-4w">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="col-md-8">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJGwEqYv0EzkwR4oJuqLh9d1s" allowfullscreen=""></iframe></div>
        </div>
    </div>
</div></section>
