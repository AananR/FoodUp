    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">Italien</h2>
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            ...
            <tr> 
              ...
              <td class="body-item mbr-fonts-style display-7"><?php echo $arrayobj[2]; ?></td><td class="body-item mbr-fonts-style display-7"><?php echo $arrayobj[3]; ?></td></tr></tbody>
          </table>
        </div>
...
<section once="" class="cid-qOAGRE3UgL" id="footer6-35">
