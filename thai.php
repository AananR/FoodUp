...
<body>
  <section class="menu cid-qOAGCu7R9e" once="menu" id="menu1-2r">
...
<section class="engine"></section><section class="mbr-section content4 cid-qOAGCusOKe" id="content4-2s">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="title col-12 col-md-8">
                <h2 class="align-center pb-3 mbr-fonts-style display-2">Thai</h2>
...
<section class="section-table cid-qOAGCuERFL" id="table1-2t">
