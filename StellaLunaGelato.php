...
<head>
  ...
  <title>Stella Luna Gelato</title>
...
<body>
  <section class="menu cid-qOznFfce6D" once="menu" id="menu1-1w">
...
<section class="engine"></section><section class="features11 cid-qOznFfwEH5" id="features11-1x">
        ...
        <div class="col-md-12">
            <div class="media-container-row">
                <div class="mbr-figure" style="width: 50%;">
                    <img src="assets/images/stella-960x720.jpg" alt="Mobirise" title="">
                </div>
...
<section class="map2 cid-qOzn2Z8URN" id="map2-w">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="col-md-8">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJBRPISegFzkwR5jVTGiak5gY" allowfullscreen=""></iframe></div>
        </div>
    </div>
</div></section>
