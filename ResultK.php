...
<body>
  <section class="menu cid-qOB3YfpWqy" once="menu" id="menu1-5o">
...
<section class="engine"></section><section class="header1 cid-qOB3YfGrr4 mbr-parallax-background" id="header1-5p">
...
$result = pg_query($conn, "SELECT RATER.NAME, RATER.JOIN_DATE, RATER.REPUTATION, RATING.DATE, RESTAURANT.NAME 
FROM RESTAURANT 
...
while ($row = pg_fetch_row($result)) {
  echo "Name: $row[0]  Join Date: $row[1] REPUTATION: $row[3] DATE: $row[4] RESTAURANT NAME: $row[5]  ";
  echo "<br />\n";
}
...
<section once="" class="cid-qOB3Yga1W5" id="footer6-5r">
