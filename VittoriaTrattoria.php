...
<head>
  ...
  <title>Vittoria Trattoria</title>
...
<body>
  <section class="menu cid-qOznOAAxwx" once="menu" id="menu1-26">
...
<section class="engine"></section><section class="features11 cid-qOznOAUXeM" id="features11-27">
        ...
        <div class="col-md-12">
            <div class="media-container-row">
                <div class="mbr-figure" style="width: 50%;">
                    <img src="assets/images/vittoria-600x300.jpg" alt="Mobirise" title="">
                </div>
...
<section class="map2 cid-qOzkrngSL4" id="map2-m">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="col-md-8">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJb3Qd0CwGzkwRh4qGnMWSXsI" allowfullscreen=""></iframe></div>
        </div>
    </div>
</div></section>
