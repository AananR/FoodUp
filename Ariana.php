...
<body>
  <section class="menu cid-qOyNx7OUcv" once="menu" id="menu1-h">
...
<section class="engine"></section><section class="features11 cid-qOzjdjAxt7" id="features11-i">
        ...
        <div class="col-md-12">
            <div class="media-container-row">
                <div class="mbr-figure" style="width: 50%;">
                    <img src="assets/images/ariana-720x405.jpg" alt="Mobirise" title="">
                </div>
...
<section class="map2 cid-qOzkrngSL4" id="map2-m">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="col-md-8">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJXdVyKKkIzkwRArMXVYCERlY" allowfullscreen=""></iframe></div>
        </div>
    </div>
</div></section>
