...
<body>
  <section class="menu cid-qOznL71IIS" once="menu" id="menu1-21">
...
<section class="engine"></section><section class="features11 cid-qOznL7qn7X" id="features11-22">
        ...
        <div class="col-md-12">
            <div class="media-container-row">
                <div class="mbr-figure" style="width: 50%;">
                    <img src="assets/images/sushi88-960x636.jpg" alt="Mobirise" title="">
                </div>
...
<section class="map2 cid-qOzkrngSL4" id="map2-m">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="col-md-8">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJebm9WvEGzkwRdc10U8bq5pk" allowfullscreen=""></iframe></div>
        </div>
    </div>
</div></section>
